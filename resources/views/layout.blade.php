                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="header__top__left">
                            <ul>
                                <li><i class="fa fa-envelope"></i>TrungShop0701@gmail.com</li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="{{-- header__logo --}}">
                       <center> <a href="{{URL::to('/trang-chu')}}"><image style="display: block;max-width:200px;max-height:150px;width: auto;height: auto;" src="{{URL::to('frontend/image/TrungShop.png')}}" alt=""></a></center>
                    </div>
                </div>
                <div class="col-lg-6">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    ...
                    <div class="footer__about">
                        ...
                        <div class="footer__about__logo">
                            <a href="{{URL::to('/trang-chu')}}"><image width="300" height="150" src="{{URL::to('upload/contact/'.$ci->info_TrungShop)}}" alt=""></a>
                        </div>
                        <ul>
