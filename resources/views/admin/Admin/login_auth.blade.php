...
<body class="off-canvas-sidebar">
  ...
  <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top text-white">
    <div class="container">
      <div class="navbar-wrapper">
        <a class="navbar-brand" >Login TrungShop</a>
      </div>
  ...
  <div class="wrapper wrapper-full-page">
    <div class="page-header register-page header-filter" filter-color="black" style="background-image: url({{asset('backend/assets/img/trungnq.jpg')}}">
      <div class="container">
        <div class="row">
      ...
      <footer class="footer">
        <div class="container">
          <div class="copyright float-right">
            ...
            <a href="https://www.creative-tim.com/" target="_blank">Trung</a> for a better web.
          </div>
        </div>
      </footer>
    </div>
